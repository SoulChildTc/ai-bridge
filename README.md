...
让终端 AI 编程助手（如 DeepSeek）通过浏览器与更强的 AI 模型（豆包、ChatGPT）对话。

> **声明**
>
> 本项目通过浏览器自动化操作 AI 聊天网页，这种方式**不属于各平台官方支持的使用方式**，可能违反相关平台的服务条款。
>
> 这个项目的诞生纯粹是因为个人经济原因——我没有能力购买 API 额度，但又确实需要在编程过程中获得更强模型的帮助。如果你有条件，**强烈建议使用各平台提供的官方 API**，它们更稳定、更可靠，也是对 AI 服务提供商的合理支持。
>
> 本项目仅供学习和个人使用，请自行评估使用风险。
